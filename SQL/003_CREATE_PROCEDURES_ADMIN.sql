...
AS BEGIN
	...
	--SELECT VALUE FROM STRING_SPLIT(@MANAGERS_TO_ASSIGN, N',')
	...
	ON M.SUPER_MANAGER_ID = U.SUPER_MANAGER_ID
...
/*
exec CLIENT_MANAGER.ASSIGN_MANAGERS @USER_LOGIN=N'oni',@MANAGERS_TO_ASSIGN=N'4',@MANAGERS_TO_UNASSIGN=N'3,2'
*/