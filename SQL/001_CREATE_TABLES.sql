...
GO
CREATE CLUSTERED INDEX MANAGERS_CI ON CLIENT_MANAGER.MANAGERS
(
	SUPER_MANAGER_ID ASC
)
GO
...
CREATE NONCLUSTERED INDEX TRANSACTIONS_CLIENT_FROM_NCI ON CLIENT_MANAGER.TRANSACTIONS
(
	CLIENT_FROM ASC
)
GO

CREATE NONCLUSTERED INDEX TRANSACTIONS_CLIENT_TO_NCI ON CLIENT_MANAGER.TRANSACTIONS
(
	CLIENT_TO ASC
)
GO